/**
 * The server task repository. The API routes and the calendar modules import
 * from this file, and the route tests replace it with vi.mock factories, so
 * code outside src/lib/server/tasks keeps using this path. The code lives in
 * the sibling modules:
 *
