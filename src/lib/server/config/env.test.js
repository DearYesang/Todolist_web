...
describe('runtime config report', () => {
	...
	it('accepts Resend as the production email delivery provider', () => {
		...
		process.env.DATABASE_URL = 'postgresql://user:pass@host/db';
		process.env.BETTER_AUTH_SECRET = 'auth-secret-with-more-than-32-characters';
		process.env.BETTER_AUTH_URL = 'https://todokanban.com';
		process.env.BETTER_AUTH_TRUSTED_ORIGINS = 'https://todokanban.com';
		process.env.PASSKEY_ORIGIN = 'https://todokanban.com';
		process.env.PASSKEY_RP_ID = 'todokanban.com';
		...
		process.env.EMAIL_FROM = 'Todokanban <no-reply@todokanban.com>';
		process.env.CALENDAR_TOKEN_SECRET = 'calendar-token-secret-with-more-than-32-characters';
